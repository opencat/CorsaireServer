...
public class MapleFamilyEntry {
    ...
    public void save() throws SQLException {
        ...
        PreparedStatement ps = con.prepareStatement("UPDATE family SET reputation = ?, todaysrep = ?, name = ?, totalreputation = ?, familyid = ?, junior1 = ?, junior2 = ? WHERE cid = ?");
