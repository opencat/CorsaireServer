...
public class MapleMapFactory {
    ...
    public final MapleMap getMap(final int mapid, final boolean respawns, final boolean npcs, final boolean reactors, final boolean monsters, final boolean forceReload) {
        ...
        if ((map == null) || (forceReload)) {
            synchronized (this) {
                ...
                for (MapleData life : mapData.getChildByPath("life")) {
                    String limitedname = MapleDataTool.getString(life.getChildByPath("limitedname"), "");
                    if (!limitedname.equals("") && !ServerConstants.LIMITED_NAMES.contains(limitedname)) {
                        continue;
                    }
    ...
    private AbstractLoadedMapleLife loadLife(MapleData life, String id, String type) {
        AbstractLoadedMapleLife myLife = MapleLifeFactory.getInstance().getLife(Integer.parseInt(id), type);
