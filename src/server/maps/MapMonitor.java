    ...
    public MapMonitor(MapleMapFactory mapleMapFactory, MapleMap mapleMap, String portalName, int portalMapId, String portalReactorName) {
        ...
        if (portalName != null) {
            ...
            if (portalReactorName != null) {
                ...
                portalMap.broadcastMessage(ReactorFactory.triggerReactor(portalReactor, 1));
            } else {
                portalReactor = null;
            }
        } else {
                ...
                if (map.getCharacters().size() < 1) {
                    ...
                    if (portal != null) {
                        ...
                        if (portalReactor != null) {
                            ...
                            portalReactor.getMap().broadcastMessage(ReactorFactory.triggerReactor(portalReactor, 0));
                        }
                    }
                }
            }
