...
/**
 * @name        InterPersonalFactory
 * @author      x711Li
 */
public class InterPersonalFactory {
    ...
    public static MaplePacket getTradeStart(MapleClient c, MapleTrade trade, byte number) {
        ...
        if (number == 1) {
            mplew.write(0);
            IntraPersonalFactory.addCharLook(mplew, trade.getPartner().getChr(), false);
            mplew.writeMapleAsciiString(trade.getPartner().getChr().getName());
        }
        mplew.write(number);
        IntraPersonalFactory.addCharLook(mplew, c.getPlayer(), false);
    ...
    public static MaplePacket sendSpouseChat(String coupleName, String msg, boolean error, boolean isSelf) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.SPOUSE_CHAT.getValue());
        if (isSelf) {
            mplew.write(4);
            mplew.write(error ? 1 : 0);
        } else {
            mplew.write(5);
            mplew.writeMapleAsciiString(coupleName);
            mplew.write(0x10);
        }
    ...
    public static MaplePacket spawnPlayerMapobject(MapleCharacter chr) {
        ...
        mplew.writeShort(0);
        IntraPersonalFactory.addRingLook(mplew, chr);
        mplew.write0(5);
        return mplew.getPacket();
    }
    ...
    public static MaplePacket getFindReply(String target, int mapid, int MTSmapCSchannel) {
        ...
        mplew.write(9);
        mplew.writeMapleAsciiString(target);
        mplew.write(MTSmapCSchannel); // 0: mts 1: map 2: cs 3: wrong ch
