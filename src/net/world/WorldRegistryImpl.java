...
public class WorldRegistryImpl extends UnicastRemoteObject implements WorldRegistry {
    ...
    private String cashShopIP = null;
    ...
    public WorldCashShopInterface registerCashShopServer(final String authKey, final String IP, final CashShopWorldInterface cb) throws RemoteException {
        try {
            ...
            PreparedStatement ps = con.prepareStatement("SELECT * FROM cashshopserver WHERE `key` = SHA1(?) AND world = ?");
            ps.setString(1, authKey);
            ...
            System.err.println("Encountered database error while authenticating cashshop server" + e);
        }
